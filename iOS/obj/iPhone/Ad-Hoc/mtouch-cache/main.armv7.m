...
extern void *mono_aot_module_BandNameiOS_info;
...
extern void *mono_aot_module_BandName_info;
...
{
	mono_aot_register_module (mono_aot_module_BandNameiOS_info);
	...
	mono_aot_register_module (mono_aot_module_BandName_info);
...
void monotouch_setup ()
{
	...
	monotouch_assembly_name = "BandNameiOS.exe";
